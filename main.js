...
//   return new Promise((resolve, reject) => {
//       // Verificar si el código de barras es una URL, dato de QR-Code
//       if (barcode.startsWith('http')) {
...
//       // Se ha recibido una gran cantidad de datos.
//       resp.on("data", (chunk) => {
//         data += chunk;
//       });

//       // Se ha recibido la respuesta completa.
//       resp.on("end", () => {
//         try {
//           const producto = JSON.parse(data);
...
//           // Verificar si la respuesta contiene información válida
//           if (producto && producto.product) {
//             // Toma el nonbre del producto aquí
//             const nombre = producto.product.product_name;
//             console.log("Nombre del producto:", nombre);
...
//             reject("No se encontro informacion valida para el codigo de barras proporcionado.");
//           }
//         } catch (error) {
//           // Capturar errores al analizar el JSON
//           console.log("Error al analizar la respuesta JSON:", error);
//           console.log(new Error ("Error al analizar la respuesta JSON."));
//         }
//       });
...
//       // Capturar errores de la solicitud
//       console.error("Error en la solicitud:", err.message);
//       // Motrar un mensaje en la consola
//       console.log("Error en la solicitud: " + err.message);
//     });
//   });
// }
